...
import { z } from "zod";
import UpsertBeneficiaryForm, { BeneficiaryDefaultValuesTypes } from "../forms/upsertBeneficiaryForm";
...
const UpsertBeneficiaryModal = ({ open, onClose, mode, defaultValue }: upsertBeneficiaryModalProps) => {
    ...
    <div>
      <Dialog open={open} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <UpsertBeneficiaryForm mode={mode} onClose={onClose} defaultValue={defaultValue} />
        </DialogContent>
      </Dialog>
    </div>
  );
