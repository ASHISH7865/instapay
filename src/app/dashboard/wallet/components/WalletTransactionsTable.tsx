                        ...
                        {paginatedTransactions?.map((transaction, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    <Badge
                                        variant={'secondary'}
                                        color={transaction.type === 'DEPOSIT' || transaction.type === 'TRANSFER' ? 'green' : 'red'}
                                    >
                                        {transaction.type}
                                    </Badge>
                                </TableCell>
                                ...
                                <TableCell>{Number(transaction.balanceBefore).toFixed(2)}</TableCell>
                                <TableCell>{Number(transaction.balanceAfter).toFixed(2)}</TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
                </Table>
